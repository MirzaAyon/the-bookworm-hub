  ...
  return (
    <div className="container my-5 ">
      <h1 className="text-center fw-bolder py-3">
        Important React.js Questions and Answers
      </h1>
      <Accordion defaultActiveKey="0" flush>
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body className="text-danger">
            ...
            DOM. React’s Dif Algorithm is used to compare the Virtual Dom
            when something is changed, React goes to the actual DOM and updates
            the node that was updated in the virtual DOM.
            <br></br>
            <img className="h-50 w-50" src="https://www.tutorialswebsite.com/wp-content/uploads/2019/09/reactjs-component-lifecycle-methods.jpeg" alt="" />
          </Accordion.Body>
        </Accordion.Item>
        <Accordion.Item eventKey="1">
          ...
          <Accordion.Body className="text-danger">
            ...
            it can not be passed to other component. State is used to set the data which are passed from useEffect.In react useState and useEffect are two important hooks
          </Accordion.Body>
        </Accordion.Item>
